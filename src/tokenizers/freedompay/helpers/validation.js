export const validateCardStorPayload = (cardNumber, expirationMonth, expirationYear, securityCode) => {
...
export const validateFreeWayPayload = (cardNumber, expirationMonth, expirationYear, securityCode, firstName, lastName, merchantReferenceCode = null) => {
    let returnVal = { ok: true, errors: [] };
